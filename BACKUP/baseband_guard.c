...
/* ===== SELinux domain whitelist (substring) + last SID fast cache ===== */
...
/* Writes: default deny; on allowed process/partition → defer to SELinux (return 0) */
...
/* ioctls: only guard destructive ones */
